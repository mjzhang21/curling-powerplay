...
tmp = pd.concat(
    [df2[["match_id","match_end_id", "h_success", "end_grp", "score_diff_before", "percent_num"]], throw_dum],
    axis=1
)
...
print("\n[score_diff_before]")
print(end_df["score_diff_before"].value_counts(dropna=False).sort_index())
